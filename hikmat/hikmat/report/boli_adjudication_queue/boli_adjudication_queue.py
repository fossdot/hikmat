...
def execute(filters=None):
    columns = [
        ...
        {"label": _("Latest transcription"), "fieldname": "transcription", "fieldtype": "Data", "width": 260},
    ...
    def add(c, queue):
        ...
        rows.append({"queue": queue, "clip": c.name, "student_name": c.student_name,
                     "prompt_text_hi": c.prompt_text_hi, "transcription": tr[:120],
